...
//        addTextChangedListener(OnTextChangeListener(callback))
    ...
    private inner class OnFocusChangeListener(internal var focusLostCallback: SimpleCallback<Void>) :
    ...
    private inner class OnTextChangeListener(internal var textChangedCallback: SimpleCallback<Void>) :
        TextWatcher {

package com.vladbakalo.location_service.service
...
import com.vladbakalo.location_service.di.DaggerLocationServiceComponent
import com.vladbakalo.location_service.di.LocationServiceComponent
...
//        stopForeground(true)
    ...
    private fun getPendingAction(): NotificationCompat.Action {
        val actionText = this.getString(if (isLocationUpdatesEnabled) com.vladbakalo.core.R.string.pause else com.vladbakalo.core.R.string.resume)
        ...
        return NotificationCompat.Action(com.vladbakalo.core.R.drawable.ic_alarm, actionText, servicePendingIntent)
    }
    ...
    private fun getNotificationTittle(): String {
        return if (isLocationUpdatesEnabled) getString(
            com.vladbakalo.core.R.string.location_alarm_running) else getString(com.vladbakalo.core.R.string.location_alarm_stopped)
    }

    private fun buildLocationServiceComponent(){
        locationServiceComponent = DaggerLocationServiceComponent.builder()
            .deps(application.locationServiceDepsProvider.locationServiceDeps)
            .build()
    }
